...
<tr><td> <em>Generated: </em> 2/27/2023 11:32:24 PM</td></tr>
<tr><td> <em>Grading Link: </em> <a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S23/init-db-setup/grade/pyu2" target="_blank">Grading</a></td></tr></table>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/123105387/221753726-1cc82e72-a4d6-47a6-906f-e59da0685bfc.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Screenshot of what is looks an error in order to see my tables<br></p>
</td></tr>
</table></td></tr>
...
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/123105387/221753977-d20ef662-7e3a-469e-a25d-977ce2fda8b2.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Here you can see the tables that were created<br></p>
</td></tr>
</table></td></tr>
</table></td></tr>
...
<tr><td> <em>Response:</em> <p>I had to do to go my php folder and copy and paste<br>all the extensions. then lookup two and delete a couple of things.&nbsp;<br></p><br></td></tr>
...
<tr><td> <em>Response:</em> <p>I had issues in the beginning&nbsp; because I downloaded the lib folder but<br>I did extracted so I had to copy the folder to database get<br>the URL go to my vsCODE and copy the URL in the .env<br>lib folder.&nbsp;<br></p><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Add the pull request link (ProjectSetup to Dev)</td></tr>
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/Pam5204/pam/pull/8">https://github.com/Pam5204/pam/pull/8</a> </td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="http://pyu2-prod.herokuapp.com/M4/sql/init_db.php">http://pyu2-prod.herokuapp.com/M4/sql/init_db.php</a> </td></tr>
</table></td></tr>
<table><tr><td><em>Grading Link: </em><a rel="noreferrer noopener" href="https://learn.ethereallab.app/homework/IT202-008-S23/init-db-setup/grade/pyu2" target="_blank">Grading</a></td></tr></table>